class TweeetsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tweeet.save
        format.html { redirect_to root_path, notice: 'Member secret was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @tweeet.update(tweeet_params)
        format.html { redirect_to @tweeet, notice: 'Member secret was successfully updated.' }
  ...
  def destroy
    @tweeet.destroy
    respond_to do |format|
      format.html { redirect_to tweeets_url, notice: 'Member was successfully destroyed.' }
